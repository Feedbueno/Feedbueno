...
background:white;">
  <div style="display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #ccc;padding:10px 0;">
    ...
    <div style="flex:1;padding:0 10px;">
      <h2 style="color:black;font-size:1em;margin:0;">
    ...
    <div style="width:13%;text-align:center;">
      <a href="{enclosure/@url}" target="_blank">
        <img src="https://cdn-icons-png.flaticon.com/512/0/375.png" alt="Reproducir episodio" style="width:100%;max-width:60px;height:auto;"/>
      </a>
